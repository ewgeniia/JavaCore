...
public class EditTaskStatusCommandTest {
    private EditTaskStatusCommand command = new EditTaskStatusCommand(new ArrayList<String>() {{
        add("1"); add("1"); add("in progress");
    }});
    ...
    public void getType() throws Exception {
        assertEquals(InputCommandType.EDIT_TASK_STATUS, command.getType());
    }
